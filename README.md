...
**专业版（完整功能）**: http://localhost:8765

**新股日历（简化版）**: http://localhost:8765/calendar
...
1. **📅 新股日历** - 实时数据、统计卡片、全部列表
2. **📊 基本面分析** - 公司概况、估值、保荐人、策略建议
3. **🤖 AI 打新策略** - AI 推荐、市场情绪、风险提示
4. **📚 打新课程** - 新手入门、申购流程、甲组 vs 乙组、孖展、绿鞋、术语表
